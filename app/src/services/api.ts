...
export async function chatEvent(agentId: number, sessionId: number, messageId: number, search: boolean, time: boolean, stream: boolean, onData: (chunk: tauriApi.MessageEvent) => void) {
